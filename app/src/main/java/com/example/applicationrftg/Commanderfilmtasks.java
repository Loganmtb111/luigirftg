...
public class Commanderfilmtasks extends AsyncTask<URL, Integer, String> {
    private volatile DetailfilmActivity screen;  // référence à l'écran

    public Commanderfilmtasks(DetailfilmActivity s) {
        this.screen = s;
    }
    ...
    protected void onPreExecute() {
        ...
        Log.d("mydebug", ">>> onPreExecute - Début de la commande");
    }
    ...
    protected String doInBackground(URL... urls) {
        ...
        Log.d("mydebug", ">>> doInBackground - Appel de la commande : " + urlAAppeler);
    ...
    protected void onPostExecute(String resultat) {
        ...
        System.out.println(">>> onPostExecute commande / resultat=" + resultat);
        Log.d("mydebug", ">>> onPostExecute - Réponse de la commande : " + resultat);

        // 🔴 IMPORTANT : On appelle la méthode de mise à jour de l'activity
        if (screen != null) {
            screen.afficherPopupCommande(resultat);
        }
    }
    ...
    private String appelerServiceRestHttp(URL urlAAppeler) {
        ...
        try {
            ...
            in.close();
            Log.d("mydebug", ">>> Résultat commande obtenu : " + sResultatAppel.substring(0, Math.min(100, sResultatAppel.length())));
